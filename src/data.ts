...
export const INITIAL_QUIZZES: Quiz[] = [
    {
        ...
        description:
            "Bài kiểm tra đánh giá kiến thức cơ bản về mệnh đề toán học, các phép toán tập hợp và các khoảng đoạn số.",
        subject: "Toán học",
        duration: 15,
    ...
    },
    {
        ...
        description:
            "Đánh giá hiểu biết về định luật Ohm cho toàn mạch, nguồn điện và các cách ghép nguồn.",
        subject: "Vật lý",
        duration: 20,
    ...
    },
    {
        ...
        description:
            'Đọc hiểu và phân tích các biện pháp nghệ thuật, nội dung tư tưởng trong tác phẩm "Tây Tiến" của Quang Dũng.',
        subject: "Ngữ văn",
        duration: 10,
