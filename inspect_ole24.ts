...
async function run() {
    ...
    while (i < buf.length - 1) {
        ...
        if (tag === 2) { // CHAR
            ...
            console.log(`CHAR: mtcode=${mtcode}, char8=${char8}, char16=${char16}, tf=${tf}, opts=${opts}`);
        } else if (tag === 0) {
            console.log("END");
        } else if (tag === 1) {
            console.log("LINE");
            ...
            console.log(`  selector=${selector}, variation=${variation}`);
            idx += 3;
        } else {
            // size/style
            if (tag === 8 || tag === 17) {
                ...
                idx += 2;
            } else if (tag === 10 || tag === 11 || tag === 12 || tag === 13 || tag === 14) {
